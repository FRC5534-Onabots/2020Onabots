...
public class limelight {
  ...
  // ledModes of the LL2
  public final double kLedModePipeLineSetting = 0;
  public final double kLedModeOff = 1;
  public final double kLefModeBlink = 2;
  public final double kLedModeForceOn = 3;

  //camModes of the LL2
  public final double kCamModeVisionProc = 0;
  public final double kCamModeDriver = 1;

  // streamModes of LL2
  public final double kStreamModeSideBySide = 0;
  public final double kStreamModePIPMain = 1;
  public final double kStreamModePIP2nd = 2;
  ...
  /**
   * setStreamMode() - Sets limelights streaming mode -0 Standard - Side-by-side
